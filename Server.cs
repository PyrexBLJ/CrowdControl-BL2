...
public class Borderlands2 : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects => new Effect[]
    {
        ...
        new("Fly", "fly_mode") { Duration = 50, Price = 150, Category = new EffectGrouping("Player Effects") },
        new("Full Ammo", "full_ammo") { Price = 50, Category = new EffectGrouping("Player Effects") },
        ...
        new("Spawn Legendary Item", "spawnloot_legendaryweapon_1") { Category = new EffectGrouping("Spawn Loot"), Price = 250 },
        new("Spawn Purple Item", "spawnloot_purpleweapon_1") { Category = new EffectGrouping("Spawn Loot"), Price = 200 },
        new("Spawn Blue Item", "spawnloot_blueweapon_1") { Category = new EffectGrouping("Spawn Loot"), Price = 150 },
        new("Spawn Green Item", "spawnloot_greenweapon_1") { Category = new EffectGrouping("Spawn Loot"), Price = 100 },
        new("Spawn White Item", "spawnloot_whiteweapon_1") { Category = new EffectGrouping("Spawn Loot"), Price = 50 },
